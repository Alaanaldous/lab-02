...
function ques1() {
  q1 = prompt('My biggest fear is Centipede.').toLowerCase();
  ...
  default:
    ...
    alert('I am very afraid of Centipede!');
    break;
  }
}
function ques2() {
  ...
  if (q2 === 'no' || q2 === 'n') {
    ...
    alert('This is very wrong, I love sea.');
  } else {
...
function ques6() {
  ...
  if (Number(q6) === 29) {
    ...
    for (var i = 3; i > 0; i--) {
      ...
      if (i === 1 && Number(q6) !== 29) {
        alert('It\'s okay that you didn\'t guess, I am 29');
      }
    }
  }
}
